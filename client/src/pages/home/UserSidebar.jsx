...
const UserSidebar = () => {
  ...
  return (
    <div className="max-w-[20em] w-full h-screen flex flex-col border-r border-r-white/10">
      <h1 className=" mx-3 rounded-lg mt-3 px-2 py-1 text-[GREEN] text-xl font-semibold text-center">
        QUICK CHAT
      </h1>
      ...
      <div className="flex items-center justify-between p-3">
        ...
        <button onClick={handleLogout} className="btn btn-success btn-sm px-4">
          Logout
        </button>
      </div>
    </div>
